						...
						<ul class="dropdown-menu" aria-labelledby="categoryMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<div class="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
									<div class="row p-4">
										...
										<div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
											...
											<div class="d-flex mb-4 position-relative">
												<img src="/frontend/images/client/uni-logo-01.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="/frontend/images/client/uni-logo-02.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="/frontend/images/client/uni-logo-03.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<div class="d-flex position-relative">
												<img src="/frontend/images/client/uni-logo-04.svg" class="icon-md" alt="">
												<div class="ms-3">
									...
									<div class="row">
										<div class="col-12">
											<div class="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden" style="background:url(/frontend/images/pattern/05.png) no-repeat center center; background-size:cover;">
												<!-- SVG decoration -->
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <a class="dropdown-item" href="index-12.html">Home Workshop<span class="badge bg-success ms-2 smaller">New</span></a></li>
						</ul>
					</li>
						...
						<div class="dropdown-menu dropdown-menu-end" data-bs-popper="none">
							<div class="row p-4 g-4">
								...
								<div class="col-xl-6 col-xxl-3">
									...
									<hr>
									<!-- Image -->
									<img src="/frontend/images/element/14.svg" alt="">

									<!-- Download button -->
									<div class="row g-2 justify-content-center mt-3">
										<!-- Google play store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="/frontend/images/client/google-play.svg" class="btn-transition" alt="google-store"> </a>
										</div>
										<!-- App store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="/frontend/images/client/app-store.svg" class="btn-transition" alt="app-store"> </a>
										</div>
									</div>
								</div>
