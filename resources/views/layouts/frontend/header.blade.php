        ...
        <div class="left-side">
            ...
            <div id="logo">
                <a href="explore.html">
                    ...
                    <img src="/frontend/images/logo-light.png" class="logo_inverse" alt="">
                    <img src="/frontend/images/logo-mobile.png" class="logo_mobile" alt="">
                </a>
            </div>
            ...
            <div class="header_search"><i class="uil-search-alt"></i> 
                ...
                <div uk-drop="mode: click;offset:10" class="header_search_dropdown">
                    ...
                    <ul>
                        <li> 
                            <a href="#">  
                                <img src="/frontend/images/avatars/avatar-1.jpg" alt="" class="list-avatar">
                                <div class="list-name">  Erica Jones </div>
                            </a> 
                        </li> 
                        <li> 
                            <a href="#">  
                                <img src="/frontend/images/avatars/avatar-2.jpg" alt="" class="list-avatar">
                                <div class="list-name">  Coffee  Addicts </div>
                            </a> 
                        </li>
                        <li> 
                            <a href="#">  
                                <img src="/frontend/images/avatars/avatar-3.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Mountain Riders </div>
                            </a> 
                        </li>
                        <li> 
                            <a href="#">  
                                <img src="/frontend/images/avatars/avatar-4.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Property Rent And Sale  </div>
                            </a> 
                        </li>
                        <li> 
                            <a href="#">  
                                <img src="/frontend/images/avatars/avatar-5.jpg" alt="" class="list-avatar">
                                <div class="list-name">  Erica Jones </div>
                            </a> 
                        </li>
                    </ul>
            ...
            <div>
                    ...
                    <ul class="dropdown_cart_scrollbar" data-simplebar>
                        <li>
                            <div class="cart_avatar">
                                <img src="/frontend/images/courses/img-1.jpg" alt="">
                            </div>
                            <div class="cart_text">
                        ...
                        <li>
                            <div class="cart_avatar">
                                <img src="/frontend/images/courses/img-2.jpg" alt="">
                            </div>
                            <div class="cart_text">
                        ...
                        <li>
                            <div class="cart_avatar">
                                <img src="/frontend/images/courses/img-3.jpg" alt="">
                            </div>
                            <div class="cart_text">
                        ...
                        <li>
                            <div class="cart_avatar">
                                <img src="/frontend/images/courses/img-4.jpg" alt="">
                            </div>
                            <div class="cart_text">
                        ...
                        <li>
                            <div class="cart_avatar">
                                <img src="/frontend/images/courses/img-5.jpg" alt="">
                            </div>
                            <div class="cart_text">
                                <h4> Become a Web Developer from Scratch to Advanced</h4>
                            </div>
                ...
                <div uk-drop="mode: click" class="header_dropdown"> 
                    ...
                    <ul class="dropdown_scrollbar" data-simplebar>
                        <li>
                            <a href="#">
                                <div class="drop_avatar"> <img src="/frontend/images/avatars/avatar-1.jpg" alt="">
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <div class="drop_avatar"> <img src="/frontend/images/avatars/avatar-2.jpg" alt="">
                                </div>
                                <div class="drop_content">
                                    <p>
                        ...
                        <li>
                            <a href="#">
                                <div class="drop_avatar"> <img src="/frontend/images/avatars/avatar-3.jpg" alt="">
                                </div>
                                <div class="drop_content">
                                    <p>
                ...
                <div uk-drop="mode: click" class="header_dropdown">
                 ...
                 <!-- profile -->
                <a href="#">
                    <img src="/frontend/images/avatars/placeholder.png" class="header_widgets_avatar" alt="">
                </a>
                        ...
                        <li>
                            <a href="#" class="user">
                                <div class="user_avatar">
                                    <img src="/frontend/images/avatars/avatar-2.jpg" alt="">
                                </div>
                                <div class="user_name">
