    ...
    <ul class="uk-slideshow-items rounded">
        <li>
            <div class="uk-position-cover" uk-slideshow-parallax="scale: 1.2,1.2,1">
                <img src="/frontend/images/hero-1.jpg" class="object-cover" alt="" uk-cover>
            </div>
        ...
        <li>
          <div class="uk-position-cover" uk-slideshow-parallax="scale: 1.2,1.2,1">
              <img src="/frontend/images/hero-2.jpg" class="object-cover" alt="" uk-cover>
          </div>
          <div class="container relative md:p-20 md:mt-7 p-5 h-full"> 
              <div uk-slideshow-parallax="scale: 1,1,0.8" class="flex flex-col justify-center h-full w-full space-y-3">
                  <h1 uk-slideshow-parallax="y: 100,0,0" class="lg:text-4xl text-2xl text-white font-semibold"> Learn from the best</h1>
          ...
          <div class="uk-slider-container px-1 py-3">
              <ul class="uk-slider-items uk-child-width-1-1@m uk-grid">
                  <li>
                      ...
                      <div class="bg-white shadow-sm rounded-lg uk-transition-toggle md:flex">
                          <div class="md:w-5/12 md:h-60 h-40 overflow-hidden rounded-l-lg relative">
                              <img src="/frontend/images/courses/img-6.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                  ...
                  <li>
                      ...
                      <div class="bg-white shadow-sm rounded-lg uk-transition-toggle md:flex">
                          <div class="md:w-5/12 md:h-60 h-40 overflow-hidden rounded-l-lg relative">
                              <img src="/frontend/images/courses/img-1.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                              <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/icon-play.svg" class="w-16 h-16 uk-position-center uk-transition-fade" alt="">
                          </div>
                          <div class="flex-1 md:p-6 p-4">
                              ...
                              <a href="course-intro.html" class="uk-link-reset">
                                  <div class="card uk-transition-toggle">
                                      <div class="card-media h-40">
                                          ...
                                          <img src="/frontend/images/courses/img-1.jpg" alt="" class="">
                          ...
                          <li>
                              ...
                              <a href="course-intro.html" class="uk-link-reset">
                                  <div class="card uk-transition-toggle">
                                      <div class="card-media h-40">
                                          <div class="card-media-overly"></div>
                                          <img src="/frontend/images/courses/img-2.jpg" alt="" class="">
                                          <span class="icon-play"></span>
                                      </div>
                                      <div class="card-body p-4">
                          ...
                          <li>
                              ...
                              <a href="course-intro.html" class="uk-link-reset">
                                  <div class="card uk-transition-toggle">
                                      <div class="card-media h-40">
                                          <div class="card-media-overly"></div>
                                          <img src="/frontend/images/courses/img-3.jpg" alt="" class="">
                                          <span class="icon-play"></span>
                                      </div>
                                      <div class="card-body p-4">
          ...
          <div class="uk-slider-container px-1 py-3">
              <ul
                  ...
                  <li>
                      <div class="card">
                          <a href="book-description.html">
                              <img src="/frontend/images/book/book4.jpg" alt="" class="w-full h-52 object-cover">
                  ...
                  <li>
                      <div class="card">
                          <a href="book-description.html">
                              <img src="/frontend/images/book/book5.jpg" alt="" class="w-full h-52 object-cover">
                  ...
                  <li>
                      <div class="card">
                          <a href="book-description.html">
                              <img src="/frontend/images/book/book1.jpg" alt="" class="w-full h-52 object-cover">
                  ...
                  <li>
                      <div class="card">
                          <a href="book-description.html">
                              <img src="/frontend/images/book/book2.jpg" alt="" class="w-full h-52 object-cover">
                  ...
                  <li>
                      <div class="card">
                          <a href="book-description.html">
                              <img src="/frontend/images/book/book3.jpg" alt="" class="w-full h-52 object-cover">
                ...
                <div class="uk-slider-container md:px-1 px-2 py-3">
                  <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2 uk-grid-small uk-grid">
                      <li>
                          <a href="episodes-watch.html">
                              <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                  <img src="/frontend/images/episodes/img-2.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                  <span
                      ...
                      <li>
                          <a href="episodes-watch.html">
                              <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                  <img src="/frontend/images/episodes/img-4.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                      ...
                      <li>
                          <a href="episodes-watch.html">
                              <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                  <img src="/frontend/images/episodes/img-1.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                  <span class="absolute bottom-2 right-2 px-2 py-1 text-xs font-semibold bg-black bg-opacity-50 text-white rounded">
                                      12:21</span>
                                  <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/icon-play.svg" class="w-12 h-12 uk-position-center" alt="">
                              </div>
                      ...
                      <li>
                          <a href="episodes-watch.html">
                              <div class="w-full md:h-40 h-28 overflow-hidden rounded-lg relative">
                                  <img src="/frontend/images/episodes/img-3.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                  <span class="absolute bottom-2 right-2 px-2 py-1 text-xs font-semibold bg-black bg-opacity-50 text-white rounded">
                                      12:21</span>
                                  <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/icon-play.svg" class="w-12 h-12 uk-position-center" alt="">
                              </div>
